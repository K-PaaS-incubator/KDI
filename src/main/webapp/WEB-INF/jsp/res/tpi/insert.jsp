		...
		<div class="ds-wrapper">
			...
			<div class="ds-box-right">
				...
				<div class="ds-input-box">
					...
					<input class="ds-input subtitle1 gray400" type="text"
						name="trnsPath" maxlength="33" required>
				</div>
			</div>
		</div>
		<div class="ds-wrapper detail-jms">
			<div class="ds-box-left">
				<div class="ds-input-box">
					...
					<input class="ds-input subtitle1 gray400" type="text"
						name="TrnsPathJmsCf" maxlength="33" required>
				</div>
				<div class="ds-input-box">
			...
			<div class="ds-box-right">
				<div class="ds-input-box">
					...
					<select class="ds-input subtitle1 gray400"
						name="trnsPathDestination">
